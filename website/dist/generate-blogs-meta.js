  ...
  "../node_modules/.pnpm/to-regex-range@5.0.1/node_modules/to-regex-range/index.js"(exports, module) {
    ...
    function splitToPatterns(min, max, tok, options) {
      ...
      for (let i = 0; i < ranges.length; i++) {
        let max2 = ranges[i];
        let obj = rangeToPattern(String(start3), String(max2), options);
        let zeros = "";
...
var require_fill_range = __commonJS({
  "../node_modules/.pnpm/fill-range@7.0.1/node_modules/fill-range/index.js"(exports, module) {
    ...
    var stringify = (start3, end, options) => {
    ...
    var toRegex = (start3, end, options) => {
      if (Array.isArray(start3)) {
        let wrap2 = options.wrap === true;
        let prefix = options.capture ? "" : "?:";
        return wrap2 ? `(${prefix}${start3.join("|")})` : start3.join("|");
      }
    ...
    var fillNumbers = (start3, end, step = 1, options = {}) => {
      let a = Number(start3);
      let b = Number(end);
      ...
      let toNumber = padded === false && stringify(start3, end, options) === false;
      let format2 = options.transform || transform(toNumber);
      if (options.toRegex && step === 1) {
        return toRange(toMaxLen(start3, maxLen), toMaxLen(end, maxLen), true, options);
      }
  ...
  "../node_modules/.pnpm/braces@3.0.2/node_modules/braces/lib/compile.js"(exports, module) {
    ...
    var compile = (ast, options = {}) => {
      let walk = (node2, parent = {}) => {
        ...
        let invalidNode = node2.invalid === true && options.escapeInvalid === true;
        let invalid2 = invalidBlock === true || invalidNode === true;
        ...
        if (node2.type === "open") {
          return invalid2 ? prefix + node2.value : "(";
        }
        if (node2.type === "close") {
          return invalid2 ? prefix + node2.value : ")";
        }
        if (node2.type === "comma") {
          return node2.prev.type === "comma" ? "" : invalid2 ? node2.value : "|";
        }
        if (node2.value) {
          return node2.value;
        }
...
var applyBaseToPattern = (pattern, base2) => isNegativePattern(pattern) ? "!" + path.posix.join(base2, pattern.slice(1)) : path.posix.join(base2, pattern);
var parseIgnoreFile = (file, cwd) => {
  const base2 = slash(path.relative(cwd, path.dirname(file.filePath)));
  return file.content.split(/\r?\n/).filter((line) => line && !line.startsWith("#")).map((pattern) => applyBaseToPattern(pattern, base2));
};
...
function factoryLabel(effects, ok2, nok, type, markerType, stringType) {
  ...
  function atBreak(code2) {
    if (code2 === null || code2 === 91 || code2 === 93 && !data2 || /* To do: remove in the future once we’ve switched from
...
// ../node_modules/.pnpm/estree-util-visit@1.2.1/node_modules/estree-util-visit/lib/color.js
function color2(d) {
  return "\x1B[33m" + d + "\x1B[39m";
}
  ...
  function build(node2, key, index2, parents) {
    ...
    function visit3() {
      ...
      if (result[0] !== SKIP2) {
        let cKey;
        for (cKey in node2) {
          if (own5.call(node2, cKey) && node2[cKey] && typeof node2[cKey] === "object" && // @ts-expect-error: custom esast extension.
...
// ../node_modules/.pnpm/micromark-util-events-to-acorn@1.2.1/node_modules/micromark-util-events-to-acorn/index.js
...
// ../node_modules/.pnpm/micromark-extension-mdx-expression@1.0.4/node_modules/micromark-extension-mdx-expression/lib/syntax.js
...
function factoryTag(effects, ok2, nok, acorn, acornOptions, addResult, allowLazy, tagType, tagMarkerType, tagClosingMarkerType, tagSelfClosingMarker, tagNameType, tagNamePrimaryType, tagNameMemberMarkerType, tagNameMemberType, tagNamePrefixMarkerType, tagNameLocalType, tagExpressionAttributeType, tagExpressionAttributeMarkerType, tagExpressionAttributeValueType, tagAttributeType, tagAttributeNameType, tagAttributeNamePrimaryType, tagAttributeNamePrefixMarkerType, tagAttributeNameLocalType, tagAttributeInitializerMarkerType, tagAttributeValueLiteralType, tagAttributeValueLiteralMarkerType, tagAttributeValueLiteralValueType, tagAttributeValueExpressionType, tagAttributeValueExpressionMarkerType, tagAttributeValueExpressionValueType) {
  ...
  function beforeLocalName(code2) {
    ...
    crash(
      code2,
      "before local name",
      "a character that can start a name, such as a letter, `$`, or `_`" + (code2 === 43 || code2 !== null && code2 > 46 && code2 < 58 ? (
        /* `/` - `9` */
...
function mdxjsEsm(options) {
  ...
  function tokenizeExportImport(effects, ok2, nok) {
    ...
    const definedModuleSpecifiers = (
      ...
      self2.parser.definedModuleSpecifiers || // @ts-expect-error: hush
      (self2.parser.definedModuleSpecifiers = [])
    );
      ...
      while (++index3 < result.estree.body.length) {
        ...
        if (node2.type === "ImportDeclaration" && !self2.interrupt) {
          ...
          while (++index4 < node2.specifiers.length) {
            definedModuleSpecifiers.push(node2.specifiers[index4].local.name);
          }
        }
      }
      Object.assign(
...
// lib/get-all-articles.ts
async function getAllArticles(tagsFilter = []) {
  const blogDir = join2(process.cwd(), "pages/blog");
  ...
  return articles.filter(
    (article) => tagsFilter.length === 0 || asArray(article.tags).some((tag) => tagsFilter.includes(tag))
  ).sort(sortByDateDesc);
}
