...
var ArrowUpRightIcon = ({ className }) => {
  return /* @__PURE__ */ jsxs2(
    "svg",
    {
      ...
      className,
      children: [
        /* @__PURE__ */ jsx6("path", { d: "M7 17L17 7", ...DEFAULT_PATH_PROPS }),
        /* @__PURE__ */ jsx6("path", { d: "M7 7H17V17", ...DEFAULT_PATH_PROPS })
      ]
    }
  );
};
...
var CaretIcon = ({ className }) => {
  return /* @__PURE__ */ jsx7(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      className,
      children: /* @__PURE__ */ jsx7("path", { d: "M1.5 1L5 4.5L8.5 1", ...DEFAULT_PATH_PROPS })
    }
  );
};
...
var CaretSlimIcon = ({ className }) => {
  return /* @__PURE__ */ jsx8(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      className,
      children: /* @__PURE__ */ jsx8("path", { d: "M4 8L12 16L20 8", ...DEFAULT_PATH_PROPS })
    }
  );
};
...
function CheckIcon({ className }) {
  return /* @__PURE__ */ jsx9("svg", { viewBox: "0 0 20 20", width: "1em", height: "1em", fill: "currentColor", className, children: /* @__PURE__ */ jsx9(
    "path",
    {
      fillRule: "evenodd",
...
var CloseIcon = ({ className }) => {
  return /* @__PURE__ */ jsxs3(
    "svg",
    {
      ...
      className,
      children: [
        /* @__PURE__ */ jsx10("path", { d: "M5.63607 5.35355L18.364 18.0815", ...DEFAULT_PATH_PROPS }),
        /* @__PURE__ */ jsx10("path", { d: "M18.0815 5.35354L5.35358 18.0815", ...DEFAULT_PATH_PROPS })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxs4(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx11("path", { d: "M15 3H21V9", ...DEFAULT_PATH_PROPS }),
        /* @__PURE__ */ jsx11("path", { d: "M10 14L21 3", ...DEFAULT_PATH_PROPS })
      ]
    }
  );
};
...
var HamburgerIcon = ({ className }) => {
  return /* @__PURE__ */ jsxs5(
    "svg",
    {
      ...
      className,
      children: [
        /* @__PURE__ */ jsx12("path", { d: "M3 12H21", ...DEFAULT_PATH_PROPS }),
        /* @__PURE__ */ jsx12("path", { d: "M3 6H21", ...DEFAULT_PATH_PROPS }),
        /* @__PURE__ */ jsx12("path", { d: "M3 18H21", ...DEFAULT_PATH_PROPS })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxs6(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx14("path", { d: "M22 6L12 13L2 6", ...DEFAULT_PATH_PROPS })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxs8(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx18("path", { d: "M21 21L16.65 16.65", ...DEFAULT_PATH_PROPS })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxs9(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx19("path", { d: "M6.44336 10.1325L11.5659 13.1175", ...DEFAULT_PATH_PROPS }),
        /* @__PURE__ */ jsx19("path", { d: "M11.5584 4.88251L6.44336 7.86751", ...DEFAULT_PATH_PROPS })
      ]
    }
  );
};
...
function Image(props) {
  return /* @__PURE__ */ jsx21(NextImage, { placeholder: "blur", ...props });
}
        ...
        children: /* @__PURE__ */ jsxs11(
          ...
          `,
            ...
            children: [
              ...
              /* @__PURE__ */ jsx22("div", { className: "overflow-y-scroll p-6 text-black dark:text-gray-300", children })
            ]
          }
        )
      }
      ...
      children: [
        /* @__PURE__ */ jsx23(
          "h3",
          {
            ...
            children: /* @__PURE__ */ jsx23(Highlight, { hit: item, attribute: "title" })
          }
        ),
...
var templates = {
  ...
  header: ({ source }) => /* @__PURE__ */ jsx24("div", { className: "aa-SourceHeader", children: /* @__PURE__ */ jsx24("div", { className: "aa-SourceHeaderTitle", children: source.sourceId }) })
};
...
var SearchBarV2 = ({
  ...
  useEffect4(() => {
    ...
    const s = autocomplete({
      ...
      renderNoResults({ Fragment: Fragment7, state: { query, status } }, root) {
          ...
          /* @__PURE__ */ jsxs14(Fragment7, { children: [
            ...
            /* @__PURE__ */ jsxs14(
              Anchor,
              {
                ...
                children: [
                  "Search by\xA0",
                  /* @__PURE__ */ jsx25("svg", { width: "77", height: "19", "aria-label": "Algolia", role: "img", children: /* @__PURE__ */ jsx25(
                    "path",
                    {
  ...
  return /* @__PURE__ */ jsx25("div", { ref: containerRef, className });
};
      ...
      children: /* @__PURE__ */ jsxs15(
        "div",
        {
          ...
          children: [
            ...
            currentRefinement && /* @__PURE__ */ jsx26(
              "button",
              {
                type: "button",
                onClick: () => refine(""),
...
var StateResults = ({
  ...
  return /* @__PURE__ */ jsx26("div", { className: "mt-9", children: content || children });
};
var Hits = ({ hits, accentColor }) => {
  ...
  const transformIcon = (item) => {
    if (item.anchor) {
      return /* @__PURE__ */ jsx26(HashTagIcon, { className: "text-gray-500 hover:text-white dark:text-white" });
    }
    if (item.content) {
      return /* @__PURE__ */ jsx26(HamburgerIcon, { className: "text-gray-500 hover:text-white dark:text-white" });
    }
      ...
      return /* @__PURE__ */ jsxs15(
        Anchor,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx26("div", { children: content })
          ]
        },
        subHit.url
      );
...
var SearchBar = ({ version = "v1", ...restProps }) => version === "v1" ? /* @__PURE__ */ jsx26(SearchBarComponent, { ...restProps }) : /* @__PURE__ */ jsx26(SearchBarV2, { ...restProps });
  ...
  return /* @__PURE__ */ jsxs15(Fragment4, { children: [
    /* @__PURE__ */ jsxs15(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx26(SearchIcon, { className: "h-6 w-6 md:mr-1 md:h-[18px] md:w-[18px]" }),
          /* @__PURE__ */ jsx26("span", { className: "hidden md:block", children: placeholder })
        ]
      }
    ),
    /* @__PURE__ */ jsx26(Modal, { title, visible: modalOpen, placement: "top", onCancel: () => handleModal(false), children: /* @__PURE__ */ jsxs15(
      InstantSearch,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx26(CustomStateResults, { children: /* @__PURE__ */ jsx26(CustomHits, { accentColor }) })
        ]
      }
    ) })
  ] });
          ...
          children: [
            /* @__PURE__ */ jsx27(
              "button",
              {
                ...
                onClick: toggleNav,
                children: /* @__PURE__ */ jsx27(HamburgerIcon, {})
              }
            ),
            ...
            /* @__PURE__ */ jsx27(Root2, { asChild: true, children: /* @__PURE__ */ jsxs16(List, { children: [
              ...
              /* @__PURE__ */ jsxs16(Nav, { isOpen: mobileNavOpen, setOpen: setMobileNavOpen, className: "gap-2", children: [
                ...
                themeSwitch && /* @__PURE__ */ jsx27(
                  "button",
                  {
                    onClick: () => setTheme(resolvedTheme === "light" ? "dark" : "light"),
                    className: "mr-1 self-center rounded-sm p-2 outline-none focus-visible:ring",
                    children: /* @__PURE__ */ jsx27(MoonIcon, { className: "fill-transparent stroke-pink-500 dark:fill-gray-100 dark:stroke-gray-100" })
                  }
                )
              ] }),
              /* @__PURE__ */ jsx27(Indicator, { className: "absolute top-9 z-50 flex h-2.5 justify-center", children: /* @__PURE__ */ jsx27("div", { className: "h-3 w-3 rotate-45 rounded-t-sm bg-white dark:bg-neutral-800" }) })
            ] }) }),
            search ? /* @__PURE__ */ jsx27(
              SearchBar,
              {
            ...
            ) : /* @__PURE__ */ jsx27("span", { className: "md:absolute" })
          ]
        }
      )
    }
      ...
      children: [
        ...
        /* @__PURE__ */ jsx28(
          "div",
          {
            ...
            children: mounted && /* @__PURE__ */ jsx28(
              ReactPlayer,
              {
                url: video.src,
...
var InfoList = ({ title, items, className }) => /* @__PURE__ */ jsx29("section", { className: clsx11("bg-white dark:bg-[#111]", className), children: /* @__PURE__ */ jsxs18("div", { className: "container max-w-[90rem] py-12", children: [
  ...
  /* @__PURE__ */ jsx29("div", { className: "flex flex-wrap", children: items.map((item, index) => /* @__PURE__ */ jsxs18(
    "section",
    {
      className: "\n              mb-9\n              box-border\n              flex\n              w-full\n              max-w-lg\n              flex-col\n              pr-10\n              last:mb-0\n              md:w-1/2\n              lg:mb-0\n              lg:w-1/3\n          ",
      children: [
        /* @__PURE__ */ jsx29("h3", { className: "m-0 text-base font-semibold text-black dark:text-gray-50", children: item.title }),
        /* @__PURE__ */ jsx29("p", { className: "mt-2 mb-4 grow text-sm text-gray-500 dark:text-gray-400", children: item.description }),
        item.link && /* @__PURE__ */ jsx29(
          Anchor,
          {
            className: "\n                  mt-auto\n                  w-max\n                  text-sm\n                  text-cyan-400\n                  hover:text-cyan-300\n                ",
            ...item.link
...
var mdxComponents = {
  ...
  iframe: ({ className, ...props }) => /* @__PURE__ */ jsx30(
    "iframe",
    {
      className: clsx12("mt-6 aspect-video w-full", className),
  ...
  img({ src = "", alt, ...props }) {
    ...
    return /* @__PURE__ */ jsx30("img", { ...props, src: src.startsWith("/") ? basePath + src : src, alt });
  }
};
...
var PackageCmd = ({ packages }) => {
  ...
  return /* @__PURE__ */ jsx31(Tabs, { items: PACKAGE_MANAGERS, children: PACKAGE_MANAGERS.map((pkgManager, index) => /* @__PURE__ */ jsx31(Tab, { children: /* @__PURE__ */ jsx31(Pre, { filename: "Terminal", hasCopyCode: true, "data-language": "sh", "data-theme": "default", children: /* @__PURE__ */ jsx31("code", { children: /* @__PURE__ */ jsx31("span", { className: "line", children: commands[index] }) }) }) }, pkgManager)) });
};
...
// src/mermaid.tsx
import { useEffect as useEffect6, useId, useState as useState4 } from "react";
...
${chart}`
  ...
  return /* @__PURE__ */ jsx33("div", { className: "mt-6 flex justify-center", dangerouslySetInnerHTML: { __html: svg } });
}
